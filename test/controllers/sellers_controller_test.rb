...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { name: @seller.name, registration: @seller.registration } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { name: @seller.name, registration: @seller.registration } }
